...
/**
 * Modal de marcação de conversão (F5-S13, DASHBOARD §13). Tipo default
 * pré-selecionado, valor obrigatório quando o tipo pede, dedup 409 → mensagem
 * amigável. DS v2: tokens, máscara BRL no valor.
 */
    ...
    <Modal open={open} onClose={onClose} title="Marcar conversão">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex justify-end gap-2">
          ...
          <Button variant="primary" disabled={!selected || register.isPending} onClick={() => void submit()}>
