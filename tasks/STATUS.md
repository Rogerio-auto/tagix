...
| F2-S04 | OpenRouterProvider (chat completion + streaming + tool calls + usage capture)                | 🔵 in-progress | critical   | F2-S02                 |
...
| F2-S10 | Column-level access control para tools de database                                           | ⏸️ blocked    | medium     | F2-S02                 |
...
| F2-S14 | Seed — 5 agent templates globais + questions + default_tools + default_model                 | ⏸️ blocked    | medium     | F2-S01                 |
