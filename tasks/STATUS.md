...
| ID      | Titulo                                                                                  | Status        | Prioridade | Depende de                |
| ------- | --------------------------------------------------------------------------------------- | ------------- | ---------- | ------------------------- |
| F25-S01 | Platform-admin guard — middleware requirePlatformAdmin (API)                            | 🔵 in-progress | critical   | —                         |
...
| F25-S09 | Runbooks de plataforma — rotate-openrouter-key + manage-workspace-agent-policy          | 🟢 available   | low        | —                         |
