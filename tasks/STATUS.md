...
| F29-S04 | Dashboard Onda B — métricas backend (qualidade, CSAT, objeções)         | 🟣 review      | high       | F29-S01          |
| F29-S05 | Dashboard Onda B — frontend (cards qualidade/CSAT + objeções rankeadas) | 🔵 in-progress | medium     | F29-S04          |
