...
| ID      | Titulo                                                          | Status        | Prioridade | Depende de |
| ------- | --------------------------------------------------------------- | ------------- | ---------- | ---------- |
| F27-S01 | PageContainer primitive + token de largura de conteúdo (DS)     | 🔵 in-progress | high       | —          |
...
| ID      | Titulo                                                                        | Status        | Prioridade | Depende de |
| ------- | ----------------------------------------------------------------------------- | ------------- | ---------- | ---------- |
| F28-S01 | Dashboard Onda A — métricas backend (performance atendente, rankings, IA ops) | 🔵 in-progress | high       | —          |
| F28-S02 | Dashboard Onda A — frontend (TableCard rico, rankings, cards IA)              | ⏸️ blocked    | high       | F28-S01    |
