...
| ID     | Titulo                                                                                              | Status        | Prioridade | Depende de             |
| ------ | --------------------------------------------------------------------------------------------------- | ------------- | ---------- | ---------------------- |
| F4-S01 | Schema Flow Builder (flows, flow_versions, flow_executions, flow_logs, flow_submissions) + RLS      | 🔵 in-progress | critical   | —                      |
| F4-S02 | "@hm/flow-engine core — types + registry + dispatcher + interpolate + stubs de handlers"            | ⏸️ blocked    | critical   | F4-S01                 |
