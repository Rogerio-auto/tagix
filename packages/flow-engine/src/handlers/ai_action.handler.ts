/**
 * Handler `ai_action` (FLOW_BUILDER.md §4).
 *
...
const ai_actionSchema = z.record(z.unknown());

export const aiActionHandler: FlowHandler<z.infer<typeof ai_actionSchema>> = {
  schema: ai_actionSchema,
