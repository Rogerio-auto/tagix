/**
 * Handler `wait_for_response` (FLOW_BUILDER.md §4).
 *
...
const wait_for_responseSchema = z.record(z.unknown());

export const waitForResponseHandler: FlowHandler<z.infer<typeof wait_for_responseSchema>> = {
  schema: wait_for_responseSchema,
