/**
 * Handler `http_request` (FLOW_BUILDER.md §4).
 *
...
const http_requestSchema = z.record(z.unknown());

export const httpRequestHandler: FlowHandler<z.infer<typeof http_requestSchema>> = {
  schema: http_requestSchema,
